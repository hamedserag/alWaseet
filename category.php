    ...
    <div class="row justify-content-around" style="margin-top: 4%">
      ...
      <script>
        ...
        if (window.innerWidth < 956) {
          console.log(window.innerWidth);
          var movable = document.getElementById("subcatcontainer");
          var movable2 = document.getElementById("searchBar");
          var place = document.getElementById("moveHere");
          place.innerHTML = movable.outerHTML + movable2.outerHTML;
          movable.classList.add("hideSmall");
          movable2.classList.add("hideSmall");
        }
      </script>
    </div>
    <!-- /.row -->
