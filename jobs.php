...
<head>
    ...
    <title>الوسيط | وظائف شاغره</title>
            ...
            <div class="col-md-9 col-sm-12 mt-5">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row justify-content-end">
                        ...
                        $query = mysqli_query($con, "SELECT `id`, `contact`, `details`,`postingdate` FROM `freejobs` ORDER BY `id` DESC LIMIT $offset, $no_of_records_per_page ");
                            ...
                            <div class="col-lg-4 col-sm-12 mt-4 postContainer" style="text-align: right;">
                                <div class="post">
                                    <div class="contentContainer">
                                        ...
                                        <b><p class="postDate"> للتواصل:  <?php echo htmlentities($row['contact']); ?></p></b>
