...
<head>
    ...
    <title>الوسيط | مطبخ الوسيط</title>
            ...
            <div class="col-md-9 col-sm-12 mt-5">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        $query = mysqli_query($con, "SELECT `id`, `title`, `details`, `image`, `postingdate` FROM `kitchen` ORDER BY `id` DESC LIMIT $offset, $no_of_records_per_page ");
                        while ($row = mysqli_fetch_array($query)) {
                        ?>
                            <div class="col-lg-4 col-sm-12 mt-4 postContainer" style="text-align: right;">
                                <div class="post">
                                    <img class="postImg" src="admin/postimages/<?php echo htmlentities($row['image']); ?>" alt="<?php echo htmlentities($row['title']); ?>">
                                    <div class="contentContainer">
                                        
                                        <p class="postDate"><?php echo htmlentities($row['postingdate']); ?></p>
                                        <a href="kitchennews-details.php?nid=<?php echo htmlentities($row['id']) ?>">
                                            <p class="postTitle"> <?php echo htmlentities($row['title']); ?></p>
                                        </a>
                                    </div>
                                </div>
                            </div>
