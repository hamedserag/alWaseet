...
if (isset($_POST['login'])) {
    ...
    $sql = mysqli_query($con, "SELECT AdminUserName,AdminEmailId,AdminPassword,rank FROM tbladmin WHERE (AdminUserName='$uname' || AdminEmailId='$uname')");
