                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="page-title-box">
                                    <h4 class="page-title">اضافه قائمه منسدله</h4>
                                    <ol class="breadcrumb p-0 m-0">
                                        <li>
                                            <a href="#">ادمن</a>
                                        </li>
                                        <li>
                                            <a href="#">قائمه منسدله </a>
                                        </li>
                                        <li class="active">
                                            اضافه قائمه منسدله
                                        </li>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box">
                                    <h4 class="m-t-0 header-title"><b>اضافه قائمه منسدله </b></h4>
                                    <hr />
                                        ...
                                        <div class="col-md-6">
                                            <form class="form-horizontal" name="category" method="post">
                                                <div class="form-group">
                                                    <label class="col-md-2 control-label">قائمه</label>
                                                    <div class="col-md-10">
                                                        <select class="form-control" name="category" required>
                                                            <option value="">اختر قائمه </option>
                                                            <?php
                                                ...
                                                <div class="form-group">
                                                    <label class="col-md-2 control-label">قائمه منسدله</label>
                                                    <div class="col-md-10">
                                                ...
                                                <div class="form-group">
                                                    <label class="col-md-2 control-label">تفاصيل القائمه المنسدله</label>
                                                    <div class="col-md-10">
