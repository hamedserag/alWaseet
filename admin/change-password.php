                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="page-title-box">
                                    <h4 class="page-title">تعديل كلمه السر</h4>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box">
                                    <h4 class="m-t-0 header-title"><b>تغيير كلمه السر </b></h4>
                                    <hr />
                                        ...
                                        <div class="col-md-10">
                                            <form class="form-horizontal" name="chngpwd" method="post" onSubmit="return valid();">
                                                ...
                                                <div class="form-group">
                                                    <label class="col-md-4 control-label">الحاليه كلمه السر</label>
                                                    <div class="col-md-8">
                                                ...
                                                <div class="form-group">
                                                    <label class="col-md-4 control-label"> كلمه السر الجديده</label>
                                                    <div class="col-md-8">
                                                ...
                                                <div class="form-group">
                                                    <label class="col-md-4 control-label">تاكيد كلمه السر</label>
                                                    <div class="col-md-8">
