                                    ...
                                    <div class="p-6">
                                        <div class="">
                                            <form name="addpost" method="post">
                                                ...
                                                <div class="form-group m-b-20">
                                                    <label for="exampleInputEmail1">القائمه</label>
                                                ...
                                                <div class="form-group m-b-20">
                                                    <label for="exampleInputEmail1">القائمه المنسدله</label>
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-12">
                                                        <div class="card-box">
                                                            <h4 class="m-b-30 m-t-0 header-title"><b>تفاصيل الخبر</b></h4>
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-12">
                                                        <div class="card-box">
                                                            <h4 class="m-b-30 m-t-0 header-title"><b>صوره الخبر</b></h4>
                                                            <img src="postimages/<?php echo htmlentities($row['PostImage']); ?>" width="300" />
                                                            <br />
                                                            <a href="change-image.php?pid=<?php echo htmlentities($row['postid']); ?>">تعديل الصوره</a>
                                                        </div>
                                                    </div>
                                                </div>
