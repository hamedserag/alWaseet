            ...
            <div class="col-md-9 col-sm-12 mt-4">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        $query = mysqli_query($con, "SELECT `id`, `url` FROM `pdf` WHERE 1 ORDER BY `id` DESC");
                        $rowcount = mysqli_num_rows($query);
                        if ($rowcount == 0) {
                            echo "النسخه الورقيه غير متوفره حاليا عذرا";
                        } else { ?>
                            <?php
                            ...
                            ?>
                                <div class="col-12 mt-4 postContainer" style="text-align: right;">
                                    <div class="post col-12">
                                        <object class="pdfViewer" type="application/pdf" width="100%" height="100%" data="admin/pdf/<?php echo htmlentities($row['url']); ?>#zoom=FitW">
