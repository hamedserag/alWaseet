...
if (isset($_POST['submit'])) {
    ...
    if (!empty($_POST['csrftoken'])) {
        if (hash_equals($_SESSION['token'], $_POST['csrftoken'])) {
            ...
            $query = mysqli_query($con, "INSERT INTO `fastnewsusers`(`name`, `email`, `number`) VALUES ('$name','$email','$number')");
            if ($query) {
                echo "<script>alert('تم الاشتراك في خدمه الاخبار العاجله ');</script>";
    ...
    <div class="container mb-5 pb-5">
        ...
        <div class="row justify-content-end py-5 my-5">
            ...
            <div class="row justify-content-center mt-4" style="margin-top: -8%">
                <div class="col-12">
                    <h1>اشترك في خدمه الاخبار العاجله</h1>
                </div>
                <div class="col-md-11">
