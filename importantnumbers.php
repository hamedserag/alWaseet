            ...
            <div class="col-md-9 col-sm-12 mt-5">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row justify-content-end">
                        <div class="col-12 row flagBg justify-content-end mb-3">
                            <h1>ارقام الطواري المصريه</h1>
                        </div>
                        
                        <div class="col-lg-4 col-sm-12 postContainer" style="text-align: right;">
                            <div class="post">
                                <div class="contentContainer">
                                    <p class="postTitle"> الشرطه المصريه</p>
                                    <p class="postDate"> 122</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-sm-12 postContainer" style="text-align: right;">
                            <div class="post">
                                <div class="contentContainer">
                                    <p class="postTitle">اداره المطافي</p>
                                    <p class="postDate"> 180</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-sm-12 postContainer" style="text-align: right;">
                            <div class="post">
                                <div class="contentContainer">
                                    <p class="postTitle">اسعاف</p>
                                    <p class="postDate"> 123</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-sm-12 mt-4 postContainer" style="text-align: right;">
                            <div class="post">
                                <div class="contentContainer">
                                    <p class="postTitle">طواري الغاز</p>
                                    <p class="postDate"> 129</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-sm-12 mt-4 postContainer" style="text-align: right;">
                            <div class="post">
                                <div class="contentContainer">
                                    <p class="postTitle">طواري الكهربا</p>
                                    <p class="postDate"> 121</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-12 row flagBg justify-content-end my-3">
                            <h1>ارقام اخري</h1>
                        </div>
                    </div>
                    <div class="row justify-content-end">
                        ...
                        $total_pages_sql = "SELECT COUNT(*) FROM kitchen";
                        $result = mysqli_query($con, $total_pages_sql);
                        $total_rows = mysqli_fetch_array($result)[0];
                        $total_pages = ceil($total_rows / $no_of_records_per_page);
                        $query = mysqli_query($con, "SELECT `id`, `number`, `details` FROM `importantnum` ORDER BY `id` DESC LIMIT $offset, $no_of_records_per_page ");
                        while ($row = mysqli_fetch_array($query)) {
                        ?>
                            <div class="col-lg-4 col-sm-12 mt-4 postContainer" style="text-align: right;">
                                <div class="post">
                                    <div class="contentContainer">
                                        <p class="postTitle"> <?php echo htmlentities($row['details']); ?></p>
                                        <p class="postDate"> <?php echo htmlentities($row['number']); ?></p>
                                    </div>
                                </div>
                            </div>
                        <?php } ?>
