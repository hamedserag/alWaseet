...
<footer class="footerBg mt-2">
  <div class="container footerBg">
    <div class="row footerContent justify-content-start">
      <!-- about -->
      <div class="col-lg-3 col-sm-11 mb-3">
        <div class="mb-3">
        ...
        <div class="row">
          <a class="col-6 footerCat" style="text-align: right;" href="#">Google Play</a>
          <a class="col-6 footerCat" style="text-align: right;" href="#">App Store</a>
        </div>
      </div>
      <!-- contact -->
      <div class="col-lg-3 col-sm-11 mb-3">
      ...
      <div class="col-lg-3 col-sm-6 row justify-content-end">
        <div class="col-10 row justify-content-end">
          <a class="footer-brand" href="index.php"> الوسيط <span class="footerSpanB">الدولي</span></a>
          <div class="row">
            <!-- fb -->
            <a class="col-2 footerLink" href="https://www.facebook.com/profile.php?id=100071667633691">
              <svg fill="#969696" class="footerIcon" id="Bold">
                <path d="m15.997 3.985h2.191v-3.816c-.378-.052-1.678-.169-3.192-.169-3.159 0-5.323 1.987-5.323 5.639v3.361h-3.486v4.266h3.486v10.734h4.274v-10.733h3.345l.531-4.266h-3.877v-2.939c.001-1.233.333-2.077 2.051-2.077z" />
              </svg>
            </a>
            <!-- ig -->
            <a class="col-2 footerLink" href="https://www.instagram.com/wseetduly_official/">
              <svg fill="#969696" class="footerIcon" id="Bold">
            ...
            <!-- messenger -->
            <a class="col-2 footerLink" href="https://www.facebook.com/messages/t/100071667633691">
              <svg fill="#969696" class="footerIcon" id="Bold">
            ...
            <!-- telegram -->
            <a class="col-2 footerLink" href="">
              <svg fill="#969696" class="footerIcon" id="Bold">
                <path d="m9.417 15.181-.397 5.584c.568 0 .814-.244 1.109-.537l2.663-2.545 5.518 4.041c1.012.564 1.725.267 1.998-.931l3.622-16.972.001-.001c.321-1.496-.541-2.081-1.527-1.714l-21.29 8.151c-1.453.564-1.431 1.374-.247 1.741l5.443 1.693 12.643-7.911c.595-.394 1.136-.176.691.218z" />
              </svg>
            </a>
            <!-- twitter -->
            <a class="col-2 footerLink" href="https://twitter.com/WseetDuly_">
              <svg fill="#969696" class="footerIcon" id="Bold">
                <path d="m21.534 7.113c.976-.693 1.797-1.558 2.466-2.554v-.001c-.893.391-1.843.651-2.835.777 1.02-.609 1.799-1.566 2.165-2.719-.951.567-2.001.967-3.12 1.191-.903-.962-2.19-1.557-3.594-1.557-2.724 0-4.917 2.211-4.917 4.921 0 .39.033.765.114 1.122-4.09-.2-7.71-2.16-10.142-5.147-.424.737-.674 1.58-.674 2.487 0 1.704.877 3.214 2.186 4.089-.791-.015-1.566-.245-2.223-.606v.054c0 2.391 1.705 4.377 3.942 4.835-.401.11-.837.162-1.29.162-.315 0-.633-.018-.931-.084.637 1.948 2.447 3.381 4.597 3.428-1.674 1.309-3.8 2.098-6.101 2.098-.403 0-.79-.018-1.177-.067 2.18 1.405 4.762 2.208 7.548 2.208 8.683 0 14.342-7.244 13.986-14.637z" />
              </svg>
            </a>
            <!-- utube -->
            <a class="col-2 footerLink" href="https://www.youtube.com/channel/UCoMPeoHB2Y3IMpF2x5BJx-Q">
              <svg fill="#969696" class="footerIcon" id="Bold">
  ...
  <div class="container-fluid">
    ...
    <div class="row devCopy justify-content-center">
      <p class="mx-3 pr-3 text-center">حقوق النشر محفوظه لموقع جريدة الوسيط الدولي</p>
      <p class="text-center">Development Copyrights &copy; 2021 | eng.hamedserag@gmail.com </p>
    </div>
  </div>
</footer>